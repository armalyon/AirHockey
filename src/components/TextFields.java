...
public class TextFields {
    ...
    public static Text initScoreDivider() {
    ...
    public static Text initPlayerWins (){
        Text p1w = new Text();
    ...
    public static Text initShowControls1 (){
    ...
    public static Text initShowControls2 (){
